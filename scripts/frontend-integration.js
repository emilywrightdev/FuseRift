 ...
 * This file demonstrates how to integrate Fuserift with a web frontend
 */

// For React/Vue/Angular applications
export class FuseriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FuseriftClient(provider, contractAddress);
